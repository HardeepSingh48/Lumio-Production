...
const PipelineLane: React.FC<PipelaneLaneProps> = ({
    ...
    const amt = new Intl.NumberFormat(undefined, {
        style: 'currency',
        currency: 'USD', // CAN CHANGE TO INR IF REQUIRED
    })
                            ...
                            <DropdownMenu>
                                <div className="bg-slate-200/30 dark:bg-background/20  h-[700px] w-[300px] px-4 relative rounded-lg overflow-visible flex-shrink-0 ">
                                    ...
                                    <Droppable
                                        ...
                                        key={laneDetails.id}
                                        type="ticket"
                                        isCombineEnabled={false} // <-- add this line if you want to disable combining
                                        isDropDisabled={false} // check this is if set to true or be removed
